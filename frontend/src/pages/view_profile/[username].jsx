                                ...
                                <div style={{display:"flex", alignItems:"center", gap:"1.2rem"}}>
                                    ...
                                    <div onClick={async ()=>{
                                     ...
                                     style={{cursor:"pointer"}}>
                                        <svg style={{width:"1.2em"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6"><path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" /></svg>
...
// this is server side rendering view_profile open karne kai baad jab view page source karo to jiski profile open kiye hai wo view page source mai dekhna cahiye right click karke view page source ka option aata hai jaise inspect kaa ata hai waise hii
